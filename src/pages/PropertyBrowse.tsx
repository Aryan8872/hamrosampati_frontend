                    ...
                    <div className="absolute right-0 top-0 h-full w-full max-w-sm bg-white shadow-xl transform transition-transform">
                        <div className="h-full flex flex-col">
                            ...
                            <div className="flex-1 overflow-y-auto p-4">
                                <TheFilter closeMobileFilter={() => setShowMobileFilters(false)} />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className='container mx-auto px-4 md:px-6 lg:px-8 py-6 md:py-8'>
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <div className="lg:w-[500px] bg-white rounded-xl shadow-sm p-4 mb-6">
                            <div className="flex flex-col md:flex-row gap-4 items-center">
                                <div className="relative flex-1 w-full">
                                    ...
                                    <input
                                        className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-3xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                                ...
                                <div className="flex gap-3 w-full md:w-auto justify-between">
                                    <button
                                        onClick={() => setShowMobileFilters(true)}
                                        className="md:hidden flex items-center gap-2 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
                                    >
                                    ...
                                    <PrimaryButton
                                        to=""
                                        className=" sm:w-[30%] flex justify-center md:w-full py-3 px-6 rounded-[15px]"
                                        onClick={handleKeywordChange}
                                        text="Search"
                                    />
                                    <button
                                        onClick={() => setShowMobileFilters(true)}
                                        className="md:flex hidden lg:hidden items-center gap-2 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
                                    >
                                        <FaFilter className="text-blue-600" />
                                        <span>Filters</span>
                                    </button>
                                    ...
                                    >
                                        {data.properties.map((property, index) => (
                                            <motion.div
                                                ...
                                                {...fadeInUp(index * 0.1)}
                                                whileHover={{ y: -5 }}
                                                className="bg-white rounded-xl shadow-sm cursor-pointer overflow-hidden hover:shadow-md transition-shadow duration-300"
                                            >
                                                <div className="relative">
                                                    ...
                                                    />
                                                    <div className="absolute bottom-2 left-2 bg-buttonColor text-white font-ManropeRegular text-xs px-2 py-1 rounded">
                                                        {property.propertyType}
                                                    </div>
                                                </div>
                                                <div className="p-4">
                                                    <div className="flex justify-between items-start mb-2">
                                                        <h3 className="font-ManropeBold text-lg text-gray-800 line-clamp-1">
                                                            {property.propertyName}
                                                        </h3>
                                                        <span className="text-xs font-ManropeLight text-gray-500 whitespace-nowrap ml-2">
                                                    ...
                                                    <div className="flex justify-between text-gray-600 text-sm mb-4">
                                                        <div className="flex font-ManropeRegular  items-center">
                                                    ...
                                                    <div className="border-t border-gray-100 pt-3">
                                                        <div className="flex justify-between items-center">
                                                            ...
                                                            <PrimaryButton
                                                                ...
                                                                text="Details"
                                                                className="text-xs font-ManropeRegular px-3 py-2 ml-2 flex-shrink-0"
                                                            />
                                                        </div>
                                                    </div>
                                                </div>
